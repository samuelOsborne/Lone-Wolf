...
public class PistolPickup implements ObjectInstance {
	...
	public PistolPickup(Vector3 position, btCollisionWorld btCollisionWorld)
	{
		this.frontDecal = Decal.newDecal(new TextureRegion(new
				Texture(Gdx.files.internal("Objects/pistol.png"))), true);
	...
	public void addCollider() {
		 ...
		 * Collider code
		 */
		model = ColliderCreator.createCollider(this.frontDecal, "pistol");
		gameObject = new GameObject.Constructor(model, "pistol", new btBoxShape(new Vector3(0.5f, 0.5f, 0.5f))).construct();
		gameObject.body.setUserValue(Halo.M40_USER_VALUE);
